...
const UpdateGroupChatModal = ({ fetchAgain, setFetchAgain, fetchMessages }) => {
  ...
  const handleRemove = async (user1) => {
    ...
    try {
      ...
      //If user removes himself, the chat is not displayed, else the user is removed
      //It needs to be changed with an separate option to delete group after leaving the group
